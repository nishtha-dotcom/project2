...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Residential</a></h5>
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Co-Working</a></h5>
                  </div>
              </div>
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Commercial</a></h5>
                  </div>
              </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="images/properties/pr4.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->

        <!-- Item 2 -->
        <div class="item">
          <img src="images/properties/pr2.jpg" class="properties" alt="properties" />
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="images/properties/pr1.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="images/properties/pr3.jpg" class="properties" alt="properties" />
...
<p class="price">200,000,000</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span> INDIA</p>
...
<div class="enquiry">
  ...
  <form role="form" action="mailto:info@clickkarogroup.com">
